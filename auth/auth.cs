...
namespace Bank_System_App
{
    ...
    public partial class auth : Form
    {
        ...
        //Path Home PC
        static public string filePath = @"C:\Users\user\source\repos\14 - C# - Level 1\Desktop app\Bank System App\data\UserData.json";
        ...
        private void Login()
        {
            ...
            if (User != null)
            {
                ...
                this.Hide();
                HomeMain HomeFormAdmin = new HomeMain(User._name, User._username ,User._accountNumber,User._balance, User._validity);
                HomeFormAdmin.Show();
            }
            else
            {
